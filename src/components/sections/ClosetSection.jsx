      ...
      <div className="relative z-20 w-full max-w-7xl overflow-y-auto max-h-screen px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gradient-to-b from-gray-900/90 to-gray-800/90 backdrop-blur-xl rounded-3xl p-8 border border-gray-800/50 shadow-2xl hover:border-gray-700/50 transition-all duration-500">
            <div className="mb-6">
              <div className="inline-block p-4 bg-gradient-to-br from-yellow-500/10 to-yellow-400/10 rounded-2xl">
            ...
            {analysisResult && (
              <div className="mt-4 p-4 bg-black/50 rounded-2xl border-2 border-gray-800">
                <div className="space-y-4">
                  ...
                  <div className="result-card bg-gradient-to-br from-yellow-900/30 to-gray-800 rounded-lg p-3 border border-yellow-700/50">
                    <p className="font-semibold text-yellow-300 mb-2 text-sm">Color Palette</p>
          ...
          <div className="bg-gradient-to-b from-gray-900/90 to-gray-800/90 backdrop-blur-xl rounded-3xl p-8 border border-gray-800/50 shadow-2xl hover:border-gray-700/50 transition-all duration-500">
            <div className="mb-6">
              <div className="inline-block p-4 bg-gradient-to-br from-yellow-500/10 to-white/10 rounded-2xl">
                <svg className="w-8 h-8 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <textarea
              ...
              className="w-full bg-black/50 border-2 border-gray-800 rounded-2xl p-4 text-white placeholder-gray-600 focus:border-yellow-500 focus:outline-none focus:ring-0 resize-none h-32 text-sm transition-all hover:border-gray-700"
            />
